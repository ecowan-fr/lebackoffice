 ...
 */
final class Version20220314012235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE microsoft_id azure_id VARCHAR(255) DEFAULT NULL');
    }
