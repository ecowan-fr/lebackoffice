 ...
 */
final class Version20220322082124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD auth_code VARCHAR(255) DEFAULT NULL, ADD twofabyemail TINYINT(1) NOT NULL, ADD trusted_version INT NOT NULL');
    }
